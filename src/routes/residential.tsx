  ...
  return c.html(`
    ...
    <body class="bg-gray-50 min-h-screen">
        ...
        <script>
            ...
            // NOTE: Auto-fetch comparables functionality has been moved to evaluation form submission
            // Comparables are now automatically fetched during evaluation without manual button click
            ...
            // NOTE: Auto-fetch land prices functionality has been moved to evaluation form submission
            // Land prices are now automatically fetched during evaluation without manual button click
