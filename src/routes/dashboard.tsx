            ...
            <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <img src="/static/icons/my-agent-logo-new.png" alt="My Agent Analytics" class="h-12" style="height: auto; max-height: 48px;">
            ...
            <div class="bg-white rounded-lg shadow p-8 mb-8">
                ...
                <div class="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <a href="/residential/evaluate" 
                       class="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:border-orange-500 hover:bg-orange-50 transition-colors">
                    ...
                    <a href="/agents" 
                       class="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-colors">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900">AIエージェント管理</p>
                            <p class="text-sm text-gray-500">エージェントを管理</p>
                        </div>
                    </a>
                </div>
            </div>
