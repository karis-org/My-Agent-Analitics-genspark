...
- **調査ロジック**: `src/lib/stigma-checker.ts` ✨ **完全書き換え・デモモード削除**
- **APIエンドポイント**: `POST /api/properties/stigma-check` ✨ **更新・デモモード削除**
